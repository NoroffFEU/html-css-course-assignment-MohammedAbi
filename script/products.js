// // Import loginUser function from user.js script
// import { loginUser } from "../script/user.js";

// // Define a global variable named products
// let products = [];
// let clickedProduct = null; // Define a global variable to store clicked product
...
//     // Fetch products from API with authorization token
...
//       products = data;
//       // Call the function to render products in HTML
...
//   // Define productBoxes after rendering products in HTML
//   const productBoxes = document.querySelectorAll(".box");

//   // Loop through each product box and attach the click event listener
//   productBoxes.forEach((box) => {
//     box.addEventListener("click", handleProductClick);
//   });
// }

// // Function to handle the click event on a product box
// function handleProductClick(event) {
//   // Get the clicked product element
//   const productBox = event.currentTarget;

//   // Extract the product information from the product element
//   const productId = productBox.dataset.productId; // Assuming each product box has a data attribute for the product ID

//   // Ensure that the productId is not null or undefined
//   if (!productId) {
//     console.error(
//       "Product ID not found in the clicked product box:",
//       productBox
//     );
//     return;
//   }
...
//   const productGender = productBox.querySelector("p:nth-child(5)").textContent; // Assuming product gender is the fifth paragraph
//   const productSizes = productBox
//     .querySelector("p:nth-child(6)")
//     .textContent.replace("Sizes: ", "")
//     .split(", "); // Assuming product sizes are listed in the sixth paragraph

//   // Fetch the product data from the products array using productId
...
//   const productPrice = parseFloat(price); // Assuming product price is a numeric value
...
//     sizes: productSizes,
//     baseColor: baseColor, // Assign baseColor directly from the fetched product data
//     price: productPrice,
//     image: {
//       url: productImageUrl,
//       alt: productImageAlt,
//     },
//     qnty: 1, // Default quantity
//     // Add other product details here if needed
//   };

//   // Save the clicked product to constant clickedProduct
//   clickedProduct = product;

//   // Log the clicked product
//   console.log("Clicked product:", clickedProduct);

//   // Redirect the user to the product specific page
...
// // Export the products and renderProducts functions
